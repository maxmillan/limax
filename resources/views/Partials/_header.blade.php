...
<!-- Mirrored from lionsbite.co.uk/html/hakduck-preview/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Feb 2020 16:11:06 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>LiMax - Home</title>
                    ...
                    <div class="col-xl-4 col-lg-3">
                        <div class="mini-cart pull-right">
                            <ul>
                                ...
                                <li>Cart<a href="javascript:void(0);" class="minicart-icon"><i class="icon_bag_alt"></i>$180.00<span>2</span></a>
                                    <div class="cart-dropdown">
                                        ...
                                        <div class="mini-cart-checkout">
                                            <a href="{{url('cart')}}" class="btn-common view-cart">VIEW CARD</a>
                                            <a href="{{url('checkout')}}" class="btn-common checkout mt-10">CHECK OUT</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
