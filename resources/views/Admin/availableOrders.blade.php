...
<section id="contents">
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Available Orders<span class="main-color">Dashboard</span></a>
            </div>
    ...
    <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
        <img src="{{asset('assets/images/products/product-details/3.jpg')}}" class="img-rounded" alt="Cinque Terre" style="height:200px;width:200px">
        <p class="text-success"><b>Name</b>: Laptop</p>
        <p class="text-success"><b>Size</b>: N/A</p>
        <p class="text-success"><b>Quantity</b>: Hp</p>
        <p class="text-success"><b>Price</b>: 30,000</p>
        <p class="text-success"><b>Customer</b>: Jane Murugi</p>
        <p class="text-success"><b>Customer Phone</b>0726470765</p>
        <p class="text-success"><b>Seller</b>: Brian Kariuki</p>
        <p class="text-success"><b>Seller Phone</b>: 0791471317</p>
